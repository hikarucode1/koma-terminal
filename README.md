...
209 tests cover the VT parser and grid (wrapping, scroll regions, scrollback
...
scroll accumulation, wheel axis selection, alternate-scroll encoding and the
whole table of where a wheel tick goes when no mouse report could be sent, mouse
